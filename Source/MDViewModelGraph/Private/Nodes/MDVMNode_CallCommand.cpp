...
{
	return Super::IsFunctionValidForNode(Func) && Func.HasAllFunctionFlags(FUNC_BlueprintCallable) && !Func.HasAnyFunctionFlags(FUNC_BlueprintPure | FUNC_Static | FUNC_Delegate);
}
