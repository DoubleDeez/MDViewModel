...
UMDViewModelBase* FMDViewModelProvider_Manual::SetViewModel(UUserWidget& Widget, const FMDViewModelAssignment& Assignment, const FMDViewModelAssignmentData& Data)
{
